...
public class CrosshairRendererManager {
    ...
    public int recentMaceDamage = 0;
    private int recentMaceDamageDisplayTicks = 0;
    ...
    public void onTick()
    {
        ...
        if (recentMaceDamageDisplayTicks > 0)
        {
            recentMaceDamageDisplayTicks--;
        } else {
            recentMaceDamage = 0;
        }
    }
    ...
    private void renderCustomIcons(DrawContext context) {
        ...
        if (ConfigManager.elytraIndicator && this.isWearingElytra()) {
            ...
            context.drawTexture(CUSTOM_MOD_ICONS, 0, 0, 10, 0, originalWidth, originalHeight);
